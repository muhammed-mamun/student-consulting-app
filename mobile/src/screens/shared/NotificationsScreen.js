...
const NotificationsScreen = () => {
  ...
  const formatDate = (dateString) => {
    ...
    const bdtDate = new Date(date.toLocaleString('en-US', { timeZone: 'Asia/Dhaka' }));
    const now = new Date(new Date().toLocaleString('en-US', { timeZone: 'Asia/Dhaka' }));
    const diffInSeconds = Math.floor((now - bdtDate) / 1000);
    ...
    return bdtDate.toLocaleDateString('en-US', { month: 'short', day: 'numeric' });
  };
